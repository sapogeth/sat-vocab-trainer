  ...
  return (
    <div className="bg-white rounded-lg border-2 border-orange-200 p-4 sm:p-6 mb-6 shadow-md">
      ...
      <div className="w-full bg-gray-200 rounded-full h-4 sm:h-6 mb-3 overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-orange-500 to-orange-600 rounded-full transition-all duration-500 ease-out flex items-center justify-end pr-2"
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
        <div className="bg-orange-50 rounded-lg p-2 sm:p-3 border border-orange-200">
          <div className="text-xl sm:text-2xl font-bold text-orange-600">{totalWords}</div>
          <div className="text-xs sm:text-sm text-gray-600">Total Words</div>
        </div>
        <div className="bg-white rounded-lg p-2 sm:p-3 border-2 border-orange-500">
          <div className="text-xl sm:text-2xl font-bold text-orange-600">{learnedWords}</div>
          <div className="text-xs sm:text-sm text-gray-600">Learned</div>
        </div>
        <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
          <div className="text-xl sm:text-2xl font-bold text-gray-600">{remaining}</div>
