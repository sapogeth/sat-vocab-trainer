  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-2xl mx-auto p-4 sm:p-6 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4">Quiz Complete!</h2>
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 sm:p-8 mb-6">
        ...
        {isPerfectScore && (
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 sm:p-6 mb-6">
            ...
            <button
              ...
              className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-all hover:scale-105 active:scale-95"
            >
              💬 Leave Feedback
            </button>
          </div>
  ...
  return (
    <div className="max-w-2xl mx-auto p-3 sm:p-6">
      <div className="mb-4 sm:mb-6">
        <button
          onClick={onBack}
          className="text-blue-600 hover:text-blue-700 font-medium mb-3 sm:mb-4 inline-block text-sm sm:text-base"
        >
          ← Back to Words
        </button>
        <div className="flex justify-between items-center mb-2 gap-2">
          <h2 className="text-xl sm:text-2xl font-bold text-blue-600">Quiz Mode</h2>
